...
- 2026-08-19 **WP-B7 前端核准閘門(Access 未拆)**:全頁 Google 登入、`docs/sql/app_profiles.sql`、`/admin` 核准頁;既有 auth.users 回填已核准,`a7033140327k@gmail.com` 為管理員。Worker JWT 與 Access 退役仍待獨立步驟。
