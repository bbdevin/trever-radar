...
5a. **任務導向 UI 資訊架構**(`docs/25`)：IA-1A/IA-1B/IA-2/IA-3/IA-4A/IA-4B 已於 2026-07-12 完成。**IA-5 個股 K線/籌碼日報分層 + IA-3b 分點追蹤買超/賣超分頁於 2026-08-20 完成**（使用者確認兩包一起做）：個股一級分頁 `K線 | 籌碼日報 | 權證`；籌碼與分點追蹤皆為買超/賣超單欄分頁；點分點下鑽進出明細+對應 K 線。
