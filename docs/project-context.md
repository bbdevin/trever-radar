...
已上線 https://radar.techtrever.com,GitHub Actions 每交易日自動更新,`main` push 也會正式部署。管線(日K/權證主檔/權證彙總/法人/融資券/產業別/雙軌歷史回補/還原因子 CLI)與前端(族群資金流+熱門/爆量/強勢/權證四榜+個股 K 線+個股權證 Tab)完成。**下一步:技術指標 → 評分模組(04;含完整權證分與 reasons/risks)**。
