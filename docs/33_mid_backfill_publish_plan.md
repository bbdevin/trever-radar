...
> 狀態：**S1 + S1.1 已實作**（2026-08-25）；**S2 程式已落地**（2026-08-26）— bf-supervisor；safe-stats＋scores；TDCC 週槽見 `docs/35`/`docs/34`  
> **S2 架構定案**（2026-08-26）：四層總圖見 [`docs/35_vps_schedule_architecture.md`](35_vps_schedule_architecture.md)  
...
- [x] **S2（2026-08-26）**:`bf-supervisor` 單寫者自啟＋ntfy；safe-stats＋scores；TDCC 週六 06:30（程式入 repo；**VPS crontab 掛載待人工**）
